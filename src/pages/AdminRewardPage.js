...
const AdminReward = (props) => {
  ...
  return (
    <Page title={(<><Link to="/my"><Typography type="h4" className={bem.e('title')}><FaArrowCircleLeft /> Admin Rewards</Typography></Link><Button color="link" onClick={()=>setAdd(true)} style={{"padding":"20px"}}><FaCartPlus /></Button></>)} className="MyPage" 
    >     
      ...
      <Row>   
        <Col md={12}>
        {
          ...
          <div className={'form-control'} key={key} style={{ marginBottom: '0rem',height:'100px'}}>
            <span>https://www.colortrades.com/api/reward/{ele._id}</span><br />
